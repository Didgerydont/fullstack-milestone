...
from . import views
from .views import bid, add_to_watch_list, get_all_auctions, get_specific_auction, display_watchlist
...
urlpatterns = [
    ...
    url(r'watching/(?P<user>\d+)', views.display_watchlist, name='display_watchlist'),
]